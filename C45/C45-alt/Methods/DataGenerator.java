...
public class DataGenerator extends Lists_Values{
    
    static int ham_file_count=0,spam_file_count=0;
    
    //Getting Ham Emails
    static public void GetHamList(String train_ham) throws FileNotFoundException{
        File dir = new File(train_ham);
    ...
    //Getting Spam Emails
    static public void GetSpamList(String train_spam) throws FileNotFoundException{

        File dir = new File(train_spam);
        File[] listoffiles = dir.listFiles();
    ...
    public static void PrintFeatures()throws FileNotFoundException{
    ...
    public static void Print_training_set(String train_ham,String train_spam,String training_set) throws FileNotFoundException{
        File dir1 = new File(train_spam);
        File[] listoffiles1 = dir1.listFiles();
        File file1=new File(training_set);
        PrintWriter writer1 = new PrintWriter(file1);
        for(File file_iterator:listoffiles1) {
          
            Scanner s = new Scanner(file_iterator);
            writer1.print("Train_"+i1+" "+"spam"+" ");
            while(s.hasNext())
            temp.add(s.next());
            for(String p:alllist){
                String check=p;
    ...
    public static void Print_testing_set(String test_ham,String test_spam,String testing_set) throws FileNotFoundException{
        File dir3 = new File(test_spam);
        File[] listoffiles3 = dir3.listFiles();
        File file2=new File(testing_set);
        PrintWriter writer2 = new PrintWriter(file2);
        for(File file_iterator:listoffiles3) {
          
            Scanner s = new Scanner(file_iterator);
            writer2.print("Test_"+i2+" "+"spam"+" ");
            while(s.hasNext())
            temp.add(s.next());
            for(String p:alllist){
                String check=p;
